...
//	});
	...
	List<FieldError> fError = bindingResult.getFieldErrors();
	...
	@ExceptionHandler(NoContentExceptionHandle.class)
	public ResponseEntity<String> noContentException(NoContentExceptionHandle ex){
		return ResponseEntity.ok(ex.getMessage());
	}
}
